...
export class SubcorpForm {
    ...
    private createTextTypesComponents(selectedTextTypes:TextTypes.ServerCheckedValues):TTInitData {
    ...
    init():void {
        this.layoutModel.init(true, [], () => {
            const ttComponent = this.createTextTypesComponents(
                this.layoutModel.getConf<TextTypes.ServerCheckedValues>('SelectedTextTypes')
            );
