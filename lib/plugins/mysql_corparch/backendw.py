...
from plugin_types.corparch.backend.regkeys import (
    POS_COLS_MAP, REG_COLS_MAP, REG_VAR_COLS_MAP, SATTR_COLS_MAP, STRUCT_COLS_MAP)
from plugins.common.mysql import MySQLOps
from plugins.mysql_corparch.backend import (
    DFLT_CORP_TABLE, DFLT_GROUP_ACC_CORP_ATTR, DFLT_GROUP_ACC_GROUP_ATTR,
    DFLT_GROUP_ACC_TABLE, DFLT_USER_ACC_CORP_ATTR, DFLT_USER_ACC_TABLE,
...
class WriteBackend(DatabaseWriteBackend[MySQLCursorAbstract]):
    ...
    async def update_corpus_posattr_references(
            self, cursor: MySQLCursorAbstract, corpus_id, posattr_id, fromattr_id, mapto_id):
        """
